  ...
  return (
    <div className="flex h-full flex-col items-center justify-center p-4">
      ...
      <button
        onClick={onLogin}
        disabled={isLoading}
        className="flex items-center gap-3 rounded-lg bg-white px-6 py-3 font-medium text-gray-700 shadow-md transition-all hover:bg-gray-50 hover:shadow-lg disabled:opacity-50 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
      >
        {isLoading ? (
          <svg
